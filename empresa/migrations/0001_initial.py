    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='empresa.personaladministrativo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idEquipamiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='empresa.equipamiento')),
                ('idServicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='empresa.servicios')),
            ],
        ),
        migrations.CreateModel(
