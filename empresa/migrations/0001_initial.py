# Generated by Django 3.2.16 on 2023-01-24 01:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='estadoPedido',
            fields=[
                ('idEstadoP', models.IntegerField(primary_key=True, serialize=False)),
                ('estado', models.CharField(choices=[('Pendiente', 'Pendiente'), ('Proceso', 'Proceso'), ('Finalizado', 'Finalizado'), ('Cancelado', 'Cancelado')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='metodoPago',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fotoOp', models.ImageField(blank=True, null=True, upload_to='uploads/')),
                ('licencia_conductor', models.BooleanField()),
                ('licencia_uso_armamento', models.BooleanField()),
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='empresa.cargo')),
                ('estado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='empresa.estado')),
